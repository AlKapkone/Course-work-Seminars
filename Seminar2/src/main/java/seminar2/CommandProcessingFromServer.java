...
import static seminar2.Interpreter.deserialize;

public class CommandProcessingFromServer {
...
//    Error ID 
    ...
    private static final byte UNKNOWN_ID = 103;
